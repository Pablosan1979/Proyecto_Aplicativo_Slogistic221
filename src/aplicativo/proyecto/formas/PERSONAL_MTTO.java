 ...
 * @author santa
 */
public class PERSONAL_MTTO extends javax.swing.JFrame {

    /**
     * Creates new form PERSONAL_MTTO
     */
    public PERSONAL_MTTO() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PERSONAL_MTTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PERSONAL_MTTO().setVisible(true);
            }
        });
    }

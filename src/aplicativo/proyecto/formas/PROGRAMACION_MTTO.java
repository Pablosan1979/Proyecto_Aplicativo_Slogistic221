 ...
 * @author santa
 */
public class PROGRAMACION_MTTO extends javax.swing.JFrame {

    /**
     * Creates new form PROGRAMACION_MTTO
     */
    public PROGRAMACION_MTTO() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PROGRAMACION_MTTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PROGRAMACION_MTTO().setVisible(true);
            }
        });
    }

 ...
 * @author santa
 */
public class FACTURACION_OK extends javax.swing.JFrame {

    /**
     * Creates new form PROVEEDORES
     */
    public FACTURACION_OK() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FACTURACION_OK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FACTURACION_OK().setVisible(true);
            }
        });
    }
